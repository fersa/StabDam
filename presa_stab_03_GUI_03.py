...
def main():
    ...
    for idx, esc_id in enumerate(escenarios_list):
        with tabs[idx + 1]:
            ...
            with col_btn1:
                if st.button(f"💾 Guardar {esc_id}", type="primary", width='stretch'):
            ...
            with col_btn2:
                if st.button(f"🔢 Calcular {esc_id}", width='stretch'):
            ...
            with col_btn3:
                if st.button(f"🗑️ Limpiar {esc_id}", width='stretch'):
